...
const phases: Phase[] = [
  ...
  },
  {
    ...
    date: "Q3 2026",
    description:
      "Deploy to production with monitoring, observability, and production-grade infrastructure.",
    features: [
      "Deployment to AWS App Runner or ECS Fargate",
      "CloudWatch Logs and Metrics integration",
      "CloudWatch Alarms for 5xx errors and latency",
      "API key authentication system",
      "Rate limiting per user/IP",
      "Custom domain (tesseric.ca)",
